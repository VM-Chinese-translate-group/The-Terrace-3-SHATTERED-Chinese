fill -150 7 69 -146 3 69 minecraft:lime_stained_glass replace minecraft:white_stained_glass

particle minecraft:end_rod -147.5 5.5 69.5 1 1 1 0.1 200 normal
particle minecraft:crimson_spore -147.5 5.5 69.5 1 1 1 0.1 200 normal
