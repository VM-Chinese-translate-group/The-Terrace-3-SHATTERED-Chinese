fill -135 3 75 -139 7 71 minecraft:lime_stained_glass replace minecraft:white_stained_glass

particle minecraft:end_rod -136.50 5.50 73.5 1 1 1 0.1 200 normal
particle minecraft:crimson_spore -136.50 5.50 73.5 1 1 1 0.1 200 normal
