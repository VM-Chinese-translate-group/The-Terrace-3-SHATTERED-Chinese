fill -133 7 60 -133 3 64 minecraft:lime_stained_glass replace minecraft:white_stained_glass

particle minecraft:end_rod -132.50 5.5 62.5 1 1 1 0.1 200 normal
particle minecraft:crimson_spore -132.50 5.5 62.5 1 1 1 0.1 200 normal
